...
class MarginCalculator:
    ...
    def calculate_portfolio_margin(self, positions: Dict[str, Position]) -> Dict[str, float]:
        """
...
class SPANMarginCalculator(MarginCalculator):
    ...
    def calculate_portfolio_margin(self, positions: Dict[str, Position]) -> Dict[str, Any]:
        ...
        for underlying, symbols in positions_by_underlying.items():
            ...
            hedge_ratio = 1.0 - min(net_delta_dollars / sum(abs(positions[s].current_delta * positions[s].contracts * 100) 
