#!/usr/bin/env python
"""
Script to run the Theta Decay Strategy with enhanced logging.

This script provides a convenient way to run the Theta Decay Strategy
...
def main():
    ...
    try:
        ...
        # Create the ThetaDecayStrategy instance
        strategy = ThetaDecayStrategy(config.get('strategy', {}), logger)
